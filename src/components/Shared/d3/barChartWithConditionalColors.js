import { chartGreen, chartRed } from '@site/src/theme/colors';
...
class BarChartWithConditionalColors extends Component {
  constructor(props) {
    super(props);
  ...
  updateSVG = () => {
    ...
    const yMax = max(this.props.data, (d) => d[this.props.yAxisName]);
    const x = scaleBand()
...
export default BarChartWithConditionalColors;
