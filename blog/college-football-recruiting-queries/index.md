...
```json title='example-output.json'
{
  "247_id": "46038819",
...
```python title='scrape_recruit_list.py'
...
```json title='recruit-ranking-histories/2020/46038819.json'
{
  "247_id": "46038819",
  "rating": 0.9995,
  "rank": 1,
...
```json title='recruit-timeline-histories/2020/46038819.json'
{
  "247_id": "46038819",
...
```python title='duplicate_composite_utility.py'
